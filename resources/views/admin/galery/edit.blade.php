            ...
            <div class="overflow-hidden shadow-sm sm:rounded-lg bg-white">
                <div class="p-6 text-gray-900">
                    <div class="p-8 rounded">
                        <h1 class="font-medium text-3xl">Edit Galery</h1>
                        <p class="text-gray-600 mt-6">Jika ingin mengupdate Galery baru, maka isilah beberapa form di
                            bawah ini</p>
                        <form method="POST" action="{{ route('galery.update', $galery) }}" enctype="multipart/form-data">
                            @csrf
                            @method('patch')
                            <div class="mt-8 grid lg:grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="nama" id="nama"
                                        ...
                                        placeholder="Nama Aplikasi"  value=" {{ old('nama',$galery->nama) }}" />
                                    @error('nama')
