            ...
            <div class="overflow-hidden shadow-sm sm:rounded-lg bg-white">
                <div class="p-6 text-gray-900">
                    <div class="p-8 rounded">
                        <h1 class="font-medium text-3xl">Edit Blog</h1>
                        <p class="text-gray-600 mt-6">Jika ingin mengedit blog baru, maka isilah beberapa form di
                            bawah ini</p>
                        <form method="POST" action="{{ route('blog.update', $blog) }}" enctype="multipart/form-data">
                            ...
                            <div class="mt-8 grid lg:grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="judul" id="judul"
                                        ...
                                        placeholder="Judul Blog" value=" {{ old('judul',$blog->judul) }}" />
                                    @error('blog')
                            ...
                            <div class="mt-8">
                                ...
                                <textarea placeholder="Deskripsi Blog" name="deskripsi" id="deskripsi" cols="30"
                                    rows="10"
                                    class="w-full bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700">{{ old('deskripsi',$blog->deskripsi) }}</textarea>
                                @error('deskripsi')
                                <p class="text-red-500 mt-2">{{$message}}</p>
                                @enderror
                            </div>
