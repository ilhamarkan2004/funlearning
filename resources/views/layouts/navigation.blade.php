<header class="g s r vd ya cj bgwhite" :class="{ 'hh sm _k dj bl ll' : stickyMenu }"
    @scroll.window="stickyMenu = (window.pageYOffset > 20) ? true : false">
    <div class="bb ze ki xn 2xl:ud-px-0 oo wf yf i">
        <div class="vd to/4 tc wf yf">
            <a href="/">
                <img class="h-14" src="build/assets/images/logo.png" alt="Logo " />
            </a>
            ...
            <div class="tc wf ig pb no">
                <div class="pc h io pa ra" :class="navigationOpen ? '!-ud-visible' : 'd'">
                    <label class="rc ab i">
                        ...
                        <!-- Icon Sun -->
                        <img class="xc nm" src="build/assets/images/icon-moon.svg" alt="Moon" />
                    </label>
                </div>
